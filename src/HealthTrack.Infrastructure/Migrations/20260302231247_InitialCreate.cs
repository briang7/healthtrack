        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkedProviderId = table.Column<Guid>(type: "uuid", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_Country = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false, defaultValue: "US"),
                    ...
                    Insurance_ExpirationDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    EmergencyContact_Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    EmergencyContact_Relationship = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecurrencePattern = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedBy = table.Column<string>(type: "text", nullable: true),
                    ModifiedBy = table.Column<string>(type: "text", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_ProviderId_ScheduledAt",
                table: "Appointments",
                columns: new[] { "ProviderId", "ScheduledAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_ProviderId_StartTime",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Providers_LicenseNumber",
                table: "Providers",
                column: "LicenseNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WaitlistEntries_PatientId_ProviderId",
